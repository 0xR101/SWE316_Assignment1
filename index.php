...
// $_SESSION['list_of_cvs']  = serialize(array($cv1, $cv2, $cv3));
            ...
            <div class="resume-select">
                ...
                <div class="list-group">
                    <?php for ($i = 0; $i < sizeof($list_of_cvs); $i++) {  ?>
                        <a href="/work/SWE316/page2.php?index=<?php echo $i; ?>" class="list-group-item list-group-item-action"><?php echo $list_of_cvs[$i]->getPersonal_information()->getName() ?><a>
            ...
            <div class="resume-output">
                <form>
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" disabled><?php echo $list_of_cvs[$index]->getPersonal_information()->getName(); ?></textarea>
                        <label for="exampleFormControlInput1">Email address</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" disabled><?php echo $list_of_cvs[$index]->getPersonal_information()->getEmails(); ?></textarea>
                        <label for="exampleFormControlInput1">Education</label>
                        <textarea style="align-content:center; overflow:auto;" class="form-control" id="exampleFormControlTextarea1" rows="10" disabled>
